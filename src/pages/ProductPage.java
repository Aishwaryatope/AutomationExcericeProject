...
public class ProductPage {
	  ...
	  @FindBy(css = ".title.text-center")
	    ...
	    public ProductPage fillSearchProductInput(String searchProduct) {
	    ...
	    public ProductPage menCategoryClick() {
	        menCategory.click();
	        return this;
	    }

	    public ProductPage tShirtsCategoryClick() {
	    ...
	    public ProductPage poloBrandClick() {
	        poloBrand.click();
	        return this;
	    }

	    public ProductPage madameBrandClick() {
	        madameBrand.click();
	        return this;
	    }

	    public ProductPage addAllProducts() {
